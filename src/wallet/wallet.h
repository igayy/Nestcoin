...
#ifndef NESTCOIN_WALLET_WALLET_H
#define NESTCOIN_WALLET_WALLET_H
...
public:
     ...
     * on this nestcoin node, and set to 0 for transactions that were created
...
#endif // NESTCOIN_WALLET_WALLET_H
