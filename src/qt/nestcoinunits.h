...
#ifndef NESTCOIN_QT_NESTCOINUNITS_H
#define NESTCOIN_QT_NESTCOINUNITS_H
...
/** Nestcoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class NestcoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit NestcoinUnits(QObject *parent);

    /** Nestcoin units.
      @note Source: https://en.nestcoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        BTC,
...
typedef NestcoinUnits::Unit NestcoinUnit;

#endif // NESTCOIN_QT_NESTCOINUNITS_H
