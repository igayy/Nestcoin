...
static void SetupNestcoinTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " nestcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  nestcoin-tx [options] <hex-tx> [commands]  Update hex-encoded nestcoin transaction\n" +
            "or:     nestcoin-tx [options] -create [commands]   Create hex-encoded nestcoin transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nestcoin transaction
