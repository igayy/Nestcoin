...
#ifndef NESTCOIN_KEYSTORE_H
#define NESTCOIN_KEYSTORE_H
...
public:
    ...
    //! Support for BIP 0013 : see https://github.com/nestcoin/bips/blob/master/bip-0013.mediawiki
