# Support for Output Descriptors in Nestcoin Core

Since Nestcoin Core v0.17, there is support for Output Descriptors in the
...
- [WIF](https://en.nestcoin.it/wiki/Wallet_import_format) encoded private keys may be specified instead of the corresponding public key, with the same meaning.
-`xpub` encoded extended public key or `xprv` encoded private key (as defined in [BIP 32](https://github.com/nestcoin/bips/blob/master/bip-0032.mediawiki)).
...
- P2SH addresses (base58, of the form `3...`, defined in [BIP 13](https://github.com/nestcoin/bips/blob/master/bip-0013.mediawiki)).
- Segwit addresses (bech32, of the form `ltc1...`, defined in [BIP 173](https://github.com/nestcoin/bips/blob/master/bip-0173.mediawiki)).
...
on Nestcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Nestcoin Core wallets, a convenience function `combo` is
