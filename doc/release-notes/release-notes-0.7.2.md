Nestcoin version 0.7.2 is now available from:
  http://sourceforge.net/projects/nestcoin/files/Nestcoin/nestcoin-0.7.2
...
* Fix use-after-free problems in initialization and shutdown, the latter of
  which caused Nestcoin-Qt to crash on Windows when exiting.
