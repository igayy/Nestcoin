Nestcoin Core version 0.10.4 is now available from:

  <https://nestcoin.org/bin/nestcoin-core-0.10.4/>
...
- #6953 `43c2789` Split nestcoin-tx into its own package
- #6953 `dfe0d4d` Include nestcoin-tx binary on Debian/Ubuntu
