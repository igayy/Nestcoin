Nestcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/nestcoin/files/Nestcoin/nestcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Nestcoin
...
New/changed settings (command-line or nestcoin.conf file)
--------------------------------------------------------
