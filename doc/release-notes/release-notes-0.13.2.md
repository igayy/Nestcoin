Nestcoin Core version 0.13.2 is now available from:
  ...
  <https://nestcoin.org/bin/nestcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update nestcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow nestcoin-tx to create v2 transactions (btcdrak)
