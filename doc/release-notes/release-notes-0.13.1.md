Nestcoin Core version 0.13.1 is now available from:

  <https://nestcoin.org/bin/nestcoin-core-0.13.1/>
...
To receive security and update notifications, please subscribe to:
  ...
  <https://nestcoincore.org/en/list/announcements/join/>
...
- **Script versioning:** Segwit makes it easy for future soft forks to allow
  ...
  currently being researched by Nestcoin Core contributors that may use this
...
[versionbits FAQ]: https://nestcoincore.org/en/2016/06/08/version-bits-miners-faq/
...
- #8848 `7a34a46` Add NULLDUMMY verify flag in nestcoinconsensus.h (jl2012)
...
- #8940 `5b4192b` Add x9 service bit support to dnsseed.bluematt.me, seed.nestcoinstats.com (TheBlueMatt, cdecker)
- #8944 `685e4c7` Remove bogus assert on number of oubound connections. (TheBlueMatt)
- #8949 `0dbc48a` Be more agressive in getting connections to peers with relevant services (gmaxwell)

### Build system
- #8293 `fa5b249` Allow building libnestcoinconsensus without any univalue (luke-jr)
- #8492 `8b0bdd3` Allow building bench_nestcoin by itself (luke-jr)
...
- #8829 `2a8bca4` Add nestcoin-tx JSON tests (jnewbery)
- #8834 `1dd1783` blockstore: Switch to dumb dbm (MarcoFalke)
- #8835 `d87227d` nulldummy.py: Don't run unused code (MarcoFalke)
- #8836 `eb18cc1` nestcoin-util-test.py should fail if the output file is empty (jnewbery)
...
- #8860 `0bee740` util: Move wait_nestcoinds() into stop_nodes() (MarcoFalke)
...
- #8683 `8a7d7ff` Fix incorrect file name nestcoin.qrc  (nestcoinsSG)
...
- #8817 `bcf3806` update nestcoin-tx to output witness data (jnewbery)
