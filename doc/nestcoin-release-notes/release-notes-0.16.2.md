Nestcoin Core version 0.16.2 is now available from:

  <https://download.nestcoin.org/nestcoin-0.16.2/>
...
- #12843 `df38b13` Test starting nestcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure nestcoind processes are cleaned up when tests end (sdaftuar)
...
- #13797 `6518bcd` nestcoinconsensus: invalid flags should be set to nestcoinconsensus_error type, add test cases covering nestcoinconsensus error codes (Thomas Kerin)
