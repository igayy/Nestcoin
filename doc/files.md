...
* nestcoin.conf: contains configuration settings for nestcoind or nestcoin-qt
* nestcoind.pid: stores the process id of nestcoind while running
...
* debug.log: contains debug information and general logging generated by nestcoind or nestcoin-qt
