...
"""Nestcoin P2P network half-a-node.
...
class P2PConnection(asyncio.Protocol):
    ...
    def peer_connect(self, dstaddr, dstport, net="regtest"):
        ...
        self.recvbuf = b""
        self.network = net
        logger.debug('Connecting to Nestcoin Node: %s:%d' % (self.dstaddr, self.dstport))
    ...
    def send_message(self, message):
        ...
        def maybe_write():
            ...
            # its existence explicitly as long as Nestcoin Core supports all
            # Python 3.4 versions.
...
class P2PInterface(P2PConnection):
    """A high-level P2P interface class for communicating with a Nestcoin node.
