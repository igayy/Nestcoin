...
# TestP2PConn: A peer we use to send messages to nestcoind, and store responses.
...
class CompactBlocksTest(NestcoinTestFramework):
    ...
    # This test actually causes nestcoind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that nestcoind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for nestcoind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # nestcoind will not send blocktxn responses for blocks whose height is
