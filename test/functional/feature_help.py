...
"""Verify that starting nestcoin with -h works as expected."""

from test_framework.test_framework import NestcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(NestcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start nestcoin with -h for help text")
        ...
        self.log.info("Start nestcoin with -version for version information")
        ...
        self.log.info("Start nestcoind with -fakearg to make sure it does not start")
